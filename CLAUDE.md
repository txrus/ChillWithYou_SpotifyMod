# ChillWithYou_SpotifyMod

BepInEx mod for *Chill with You: Lo-Fi Story* that adds an in-game Spotify player (playback control, search, and playlist selection) via the Spotify Web API. See `README.md` for build and install instructions.
